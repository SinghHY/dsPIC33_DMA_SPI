...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/SPI_Fast.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifeq (1,1) 
	...
	@mv ${OBJECTDIR}/Main.cof "dist/${CND_CONF}/${IMAGE_TYPE}/SPI_Fast.X.${IMAGE_TYPE}.cof" 
	@mv ${OBJECTDIR}/Main.hex "dist/${CND_CONF}/${IMAGE_TYPE}/SPI_Fast.X.${IMAGE_TYPE}.hex"
else 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/SPI_Fast.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
ifeq (1,1) 
	
else 
	${MP_LD}   out="dist/${CND_CONF}/${IMAGE_TYPE}"  +FD +DF +CC LINK=SPI_Fast.X.${IMAGE_TYPE}.hex=${OBJECTDIR}/Main.o +Y=9 +EA +DF +LN +T +A +M +J +EA +Z -P
